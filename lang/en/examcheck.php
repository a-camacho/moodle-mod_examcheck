...
$string['quickfilterall'] = 'All students';
$string['quickfilterchecked'] = 'Checked';
$string['quickfiltergroup'] = 'Filter by check status';
$string['quickfilternotchecked'] = 'Not yet checked';
