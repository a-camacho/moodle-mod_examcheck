...
/**
 * Event fired when a student is marked as checked for a step.
 *
 ...
 *      - int stepid: the step the student was checked for.
 *      - string stepname: the name of the step.
 *      - string method: how the mark was recorded.
 * }
 */
class user_marked extends base {
     ...
     * @param stdClass $mark The mark record (with id set).
    ...
    public static function get_name(): string {
        return get_string('eventusermarked', 'mod_examcheck');
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' marked the user with id '{$this->relateduserid}' as checked " .
