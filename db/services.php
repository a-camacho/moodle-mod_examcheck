...
$functions = [
    ...
    'mod_examcheck_unmark_user' => [
        ...
        'description'  => 'Remove a student\'s check for a step, with optional reason documentation.',
        'type'         => 'write',
        'capabilities' => 'mod/examcheck:uncheck',
        'ajax'         => true,
    ],
    ...
    'mod_examcheck_exempt_user' => [
        'classname'    => 'mod_examcheck\external\exempt_user',
        'description'  => 'Grant or revoke a step exemption for a student.',
        'type'         => 'write',
        'capabilities' => 'mod/examcheck:exempt',
        'ajax'         => true,
    ],
    'mod_examcheck_flag_user' => [
        'classname'    => 'mod_examcheck\external\flag_user',
        'description'  => 'Add or remove a student flag (malpractice, exclusion, etc.).',
        'type'         => 'write',
        'capabilities' => 'mod/examcheck:flag',
        'ajax'         => true,
    ],
];
